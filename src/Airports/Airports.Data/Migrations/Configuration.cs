namespace Airports.Data.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<AirportsDbContext>
    {
        ...
        protected override void Seed(Airports.Data.AirportsDbContext context)
        {
            ...
            context.Countries.AddOrUpdate(c => c.Name, bulgaria, france, germany, spain, uk);
            context.SaveChanges();
            ...
            context.Cities.AddOrUpdate(c => c.Name, sofia, paris, berlin, barcelona, london);
            context.SaveChanges();
            ...
            context.Airports.AddOrUpdate(a => a.AirportCode,
            ...
            context.Airlines.AddOrUpdate(a => a.Name,
            ...
            context.Flights.AddOrUpdate(f => f.FlightCode, flightSofiaParis);
            context.SaveChanges();
            context.Dispose();
            ...
            context.Flights.AddOrUpdate(f => f.FlightCode, flightParisBerlin);
            context.SaveChanges();
