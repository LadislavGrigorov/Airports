namespace Airports.Data.SqlServer.Migrations
{
    using Airports.Models;
    using System;
    using System.Data.Entity.Migrations;

    public sealed class Configuration : DbMigrationsConfiguration<AirportsDbContextSqlServer>
    {
        ...
        protected override void Seed(Airports.Data.SqlServer.AirportsDbContextSqlServer context)
        {
            using (AirportsDbContextSqlServer dbContext = new AirportsDbContextSqlServer())
            {
